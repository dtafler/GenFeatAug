...
def main():
    ...
    data_paths = {
        ...
        'cifar10_bal': '/mnt/dtafler/test/timm/vit_base_patch14_dinov2.lvd142m/cifar10_bal',
        'cifar100_0.01': '/mnt/dtafler/test/timm/vit_base_patch14_dinov2.lvd142m/cifar100_0.01',
        'cifar100_bal': '/mnt/dtafler/test/timm/vit_base_patch14_dinov2.lvd142m/cifar100_bal'
    }
    save_path = './experiments/embeddings/fid_trained_models'
